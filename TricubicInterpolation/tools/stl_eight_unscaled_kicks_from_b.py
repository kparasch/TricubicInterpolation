...
write_func(ff, sp_list, range(8), 0)
ff.write(
'''
    return;
}
...
write_func(ff, sp_list, range(8,16), 8)
...
write_func(ff, sp_list, range(16,24), 16)
...
write_func(ff, sp_list, range(24,32), 24)
...
write_func(ff, sp_list, range(32,40), 32)
...
write_func(ff, sp_list, range(40,48), 40)
...
write_func(ff, sp_list, range(48,56), 48)
...
write_func(ff, sp_list, range(56,64), 56)
