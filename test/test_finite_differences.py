...
f = sum([ x**i*y**j*z**k for i in range(2) for j in range(2) for k in range(2)])
f = 1 + x + y + z + x*y + x*z + y*z + x*y*z
print(f)
...
#print(np.equal(ip.construct_b(3,6,2),ip2.construct_b(3,6,2)))
#print(ip.construct_b(3,6,2)-ip2.construct_b(3,6,2))
print(np.array_equal(ip.construct_b(3,6,2),ip2.construct_b(3,6,2)))
#ix = int(x0)
#iy = int(y0)
#iz = int(z0)
#
